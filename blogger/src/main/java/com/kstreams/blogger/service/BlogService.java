...
public class BlogService {
  ...
  public static final String BLOG_TOPIC = "blog_created_event_topic_v3";
  ...
  public CompletableFuture<Blog> save(Blog blog) {
    ...
    var event = new BlogCreatedEvent(entity.getId(), entity.getUserId(), entity.getTitle(), entity.getContent());
